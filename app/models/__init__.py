...
class User(UserMixin, db.Model):
    ...
    patient_follow_ups = db.relationship('FollowUp', backref='patient', lazy=True,
                                       foreign_keys='FollowUp.patient_id')
    doctor_follow_ups = db.relationship('FollowUp', backref='doctor', lazy=True,
...
class HealthRecord(db.Model):
    ...
    doctor_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=True)  # 允许为空，表示待审核
